...
const orderSchema = new mongoose.Schema({
  ...
  orderNumber: {
    type: String
    // unique: true removed here to prevent duplicate index warning since it's indexed below
  },
  items: [{
    product: {
      type: mongoose.Schema.Types.ObjectId,
...
orderSchema.index({ orderNumber: 1 }, { unique: true }); // Keep unique index here
