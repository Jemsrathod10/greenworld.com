...
// ✅ 1. ADD THIS: Review Schema (Must be defined before ProductSchema)
const reviewSchema = new mongoose.Schema(
  ...
  {
    timestamps: true, // Adds createdAt automatically for reviews
  }
);

// 2. Your Existing Product Schema
...
// Virtuals and Middleware (Keep exactly as you had them)
